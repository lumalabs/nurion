...
**Files Modified**:
- `runtime/runtime/core/stage_master.py` - Modified `_create_queue` method to dynamically set partition count
- `runtime/runtime/queue/tansu.py` - Support partition assignment and rebalance
- `runtime/runtime/core/worker.py` - Workers use consumer group for partition assignment
...
**Files Modified**:
- `runtime/runtime/core/stage_master.py` - Add partition progress monitoring and skew detection
- `runtime/runtime/core/models.py` - Add partition metrics to `StageMetrics`
- `runtime/runtime/queue/tansu.py` - Support querying offsets by partition
...
**Files Modified**:
- `runtime/runtime/core/stage_master.py` - Complete backpressure signal generation and propagation
- `runtime/runtime/operators/sources/source.py` - Implement universal source rate control
- `runtime/runtime/operators/sources/sparkv2.py` - Integrate backpressure checks
- `runtime/runtime/operators/sources/spark.py` - Integrate backpressure checks (if needed)
- `runtime/runtime/operators/sources/lance.py` - Integrate backpressure checks (if needed)
- `runtime/runtime/operators/sources/file.py` - Integrate backpressure checks (if needed)
- `runtime/runtime/core/operator.py` - Add backpressure awareness interface
- `runtime/runtime/actors/meta_service.py` - Implement backpressure propagation mechanism
...
**File: `runtime/runtime/core/stage_master.py`**
...
**File: `runtime/runtime/queue/tansu.py`**
...
**File: `runtime/runtime/core/worker.py`**
