...
| Purpose | File |
|---------|------|
| SemanticGuarantee enum | `engine/core/operator.py` |
| Operator dedup logic | `engine/core/operator.py` |
| StageConfig | `engine/core/stage_config.py` |
| Config propagation | `engine/engine/ray_runner.py` |
| Worker creation | `engine/core/managers/worker_manager.py` |
| Processing loop | `engine/core/stage_worker.py` |
| Fault injection | `engine/testing/fault_injection.py` |
