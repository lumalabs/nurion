...
"""Shared test fixtures for control plane tests.
...
from control.core.settings import IcebergCatalogSettings, Settings

# Import all models to ensure they're registered with the metadata
from control.models import iceberg, k8s, lance  # noqa: F401
...
def test_settings(database_url: str, minio_endpoint: str) -> Settings:
    ...
    return Settings(
        app_name="Nurion Control Plane Test",
        environment="test",
