# Nurion Control Plane

FastAPI-based control plane for Nurion. Provides task management, Kubernetes integration, and data lake catalog APIs.

## Role in the Platform

The control plane connects tasks, infrastructure, and data products across the platform.
