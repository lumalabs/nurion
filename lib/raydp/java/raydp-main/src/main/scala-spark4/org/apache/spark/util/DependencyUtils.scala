...
// Spark-4 patch: the ivy helpers moved from deploy.SparkSubmitUtils to util.MavenUtils.
// MavenUtils lives in the same package as this file, so no explicit import is needed.
...
private[spark] object DependencyUtils extends Logging {
  ...
  def resolveMavenDependencies(
    ...
    // Spark 4 moved these helpers to MavenUtils and added an implicit PrintStream.
    implicit val printStream: java.io.PrintStream = System.err
