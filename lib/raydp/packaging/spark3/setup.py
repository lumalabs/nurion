...
"""Build entrypoint for the Spark 3.x / Scala 2.12 wheel."""
...
# JAR suffix filter both resolve to Scala 2.12.
os.environ["NURION_RAYDP_FLAVOR"] = "spark3"

# _build_hooks lives in the shared source root at ../../ .
