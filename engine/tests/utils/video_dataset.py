...
VIDEO_ARCHIVE_URL_ENV = "NURION_TEST_VIDEO_ARCHIVE_URL"
VIDEO_ARCHIVE_SHA_ENV = "NURION_TEST_VIDEO_ARCHIVE_SHA256"
VIDEO_ARCHIVE_FILENAME_ENV = "NURION_TEST_VIDEO_ARCHIVE_FILENAME"
VIDEO_SOURCE_OVERRIDE_ENV = "NURION_TEST_VIDEO_SOURCE_DIR"
VIDEO_LIMIT_ENV = "NURION_TEST_VIDEO_LIMIT"
...
def _determine_archive_filename(url: str) -> str:
    ...
    return candidate or "nurion_test_videos.tar.gz"
    ...
    if tarfile.is_tarfile(archive_path):
        with tarfile.open(archive_path, "r:*") as tar:
            ...
            for member in mp4_members:
                ...
                with tempfile.TemporaryDirectory(prefix="nurion_extract_") as tmp:
        ...
        with tempfile.TemporaryDirectory(prefix="nurion_video_", dir=str(dest_dir.parent)) as tmp:
            tmp_dir = Path(tmp)
