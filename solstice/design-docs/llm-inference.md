...
Solstice provides three modes for LLM inference:
...
Loads vLLM/SGLang engine directly inside Solstice workers. Zero HTTP overhead.
...
### Mode 2: External with solstice.serve (Multi-model + dynamic scaling)
