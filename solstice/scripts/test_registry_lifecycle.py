...
def test_registry_basic():
    ...
    from solstice.serve.registry import get_or_create_registry, REGISTRY_ACTOR_NAME
...
def test_model_client(registry_handle):
    ...
    from solstice.serve.registry import REGISTRY_ACTOR_NAME
...
async def test_registry_with_simulated_workflow():
    ...
    from solstice.serve.client import ModelClient
    from solstice.serve.registry import REGISTRY_ACTOR_NAME, get_or_create_registry
